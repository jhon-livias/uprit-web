...
class SyncPosgradoObservacionEstados extends Command
{
    protected $signature = 'observaciones:sync-posgrado-estados {--dry-run : Muestra cambios sin guardar}';

    protected $description = 'Actualiza estados del kanban para observaciones Posgrado Edmundo Gonzales (import_id #111–#116)';

    public function handle(): int
    {
        $mapping = config('observaciones_estados_posgrado', []);
