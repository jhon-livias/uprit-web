...
@section('content')
@include('web.partials.breadcrumb', ['title' => 'Talleres y Servicios Culturales', 'route' => 'talleres'])
            ...
            <div class="col-lg-8">
                <div class="privacy-policy">
                    <div class="text-block">
                        <h3 class="title">Actividades Culturales</h3>
                        <ul>
                                        ...
                                        <div class="accordion edu-accordion edu-accordion-sec" id="accordionExample" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <div class="course-lesson">
                                                            <p>
                                                                Participa en proyecciones semanales y debates sobre cine de diferentes géneros y épocas.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingTwo">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                        Viernes Cultural Fest.
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <div class="course-lesson">
                                                            <p>Disfruta de eventos artísticos y culturales que se celebran cada viernes, con música, teatro y exposiciones.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <div class="course-lesson">
                                                            <p>Únete a la comunidad de lectores para compartir ideas, analizar libros y descubrir nuevas obras.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
