                        ...
                        <div class="col-lg-4 col-md-6">
                            <div style="background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 10px 25px rgba(0,0,0,.08);height:100%;">
                                ...
                                <div style="padding:25px;text-align:center;">
                                    ...
                                    <a href="https://wa.me/51933248529?text=Hola,%20necesito%20informaci%C3%B3n%20sobre%20admisi%C3%B3n" target="_blank" rel="noopener noreferrer" style="display:block;background:#25D366;color:#fff;padding:12px;border-radius:10px;text-decoration:none;margin-bottom:10px;">
                                        <i class="ri-whatsapp-line"></i> Contactar
                                    </a>

                                    <a href="https://wa.me/51933248529?text=Hola,%20quiero%20programar%20una%20cita%20con%20un%20asesor" target="_blank" rel="noopener noreferrer" style="display:block;border:1px solid #ddd;color:#444;padding:12px;border-radius:10px;text-decoration:none;">
