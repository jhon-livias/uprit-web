!function (t, e) {
    ...
    var e = "SweetAlert2:", p = function (e) {
        ...
        }, t = Object.freeze({cancel: "cancelar", backdrop: "backdrop", close: "close", esc: "esc", timer: "timer"}),
        n = function (t) {
            var e = {};
        ...
        g = n(["success", "warning", "info", "question", "error"]), b = {previousBodyPadding: null},
        y = function (t, e) {
    ...
    var P, L = function (t) {
        ...
        at = function (t) {
            Gt.isVisible() && P !== t.target.value && Gt.resetValidationMessage(), P = t.target.value
        }, st = function (t) {
            var e;
            if ((e = R()) && (e.parentNode.removeChild(e), T([document.documentElement, document.body], [x["no-backdrop"], x["toast-shown"], x["has-column"]])), it()) k("SweetAlert2 requires document to initialize"); else {
    ...
    var dt = function (t) {
        var e, n, o, i, r = R();
        r && (e = r, "string" == typeof (n = t.backdrop) ? e.style.background = n : n || O([document.documentElement, document.body], x["no-backdrop"]), !t.backdrop && t.allowOutsideClick && C('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), o = r, (i = t.position) in x ? O(o, x[i]) : (C('The "position" parameter is not valid, defaulting to "center"'), O(o, x.center)), function (t, e) {
            if (e && "string" == typeof e) {
                var n = "grow-" + e;
                n in x && O(t, x[n])
            }
        }(r, t.grow), S(r, t.customClass, "container"), t.customContainerClass && O(r, t.customContainerClass))
    }, pt = function (t) {
        var e = K().querySelector("#" + x.content);
        t.html ? (ct(t.html, e), j(e, "block")) : t.text ? (e.textContent = t.text, j(e, "block")) : q(e), function (e) {
            ...
            switch (e.input) {
                ...
                case"file":
                    ...
                    break;
                case"range":
                    var d = M(n, x.range), p = d.querySelector("input"), f = d.querySelector("output");
                ...
                case"radio":
                    ...
                    break;
                case"checkbox":
                    var v = M(n, x.checkbox), b = A(n, "checkbox");
        ...
        j(u), u.innerHTML = "";
        var l = parseInt(null === c.currentProgressStep ? Gt.getQueueStep() : c.currentProgressStep);
        ...
        var e, n, o, i, r = X();
        S(r, t.customClass, "header"), gt(t), function (t) {
            var e = z();
            if (e && e.classList.contains(g[t.type])) S(e, t.customClass, "icon"); else if (ft(), t.type) if (mt(), -1 !== Object.keys(g).indexOf(t.type)) {
        ...
        var e, n, o, i;
        e = t, n = U(), V(n, "width", e.width), V(n, "padding", e.padding), e.background && (n.style.background = e.background), n.className = x.popup, e.toast ? (O([document.documentElement, document.body], x["toast-shown"]), O(n, x.toast)) : O(n, x.modal), S(n, e.customClass, "popup"), "string" == typeof e.customClass && O(n, e.customClass), E(n, x.noanimation, !e.animation), dt(t), ht(t), pt(t), function (t) {
            var e = J(), n = Y(), o = $();
    ...
    var bt = [], yt = function () {
        ...
        Bt = ["title", "titleText", "text", "html", "type", "customClass", "showConfirmButton", "showCancelButton", "confirmButtonText", "confirmButtonAriaLabel", "confirmButtonColor", "confirmButtonClass", "cancelButtonText", "cancelButtonAriaLabel", "cancelButtonColor", "cancelButtonClass", "buttonsStyling", "reverseButtons", "imageUrl", "imageWidth", "imageHeigth", "imageAlt", "imageClass", "progressSteps", "currentProgressStep"],
        xt = {
        ...
        At = function (t) {
            ...
            queue: function (t) {
                ...
                bt = t;
                var a = function (t, e) {
                    bt = [], document.body.removeAttribute("data-swal2-queue-step"), t(e)
                }, s = [];
                return new Promise(function (i) {
                    !function e(n, o) {
                        n < bt.length ? (document.body.setAttribute("data-swal2-queue-step", n), r.fire(bt[n]).then(function (t) {
            ...
            stopTimer: function () {
                return wt.timeout && wt.timeout.stop()
            },
            resumeTimer: function () {
                return wt.timeout && wt.timeout.start()
            },
            ...
            increaseTimer: function (t) {
                return wt.timeout && wt.timeout.increase(t)
            },
    ...
    function Ot() {
        var t = Et.innerParams.get(this), e = Et.domCache.get(this);
    ...
    var Tt = function () {
        ...
        "undefined" != typeof window && jt() && window.removeEventListener("resize", qt)
    }, It = function () {
        f(document.body.children).forEach(function (t) {
            t.hasAttribute("data-previous-aria-hidden") ? (t.setAttribute("aria-hidden", t.getAttribute("data-previous-aria-hidden")), t.removeAttribute("data-previous-aria-hidden")) : t.removeAttribute("aria-hidden")
        })
    }, Rt = {swalPromiseResolve: new WeakMap};

    function Nt(t, e) {
        ot() ? _t(e) : (Ct().then(function () {
            return _t(e)
        }), wt.keydownTarget.removeEventListener("keydown", wt.keydownHandler, {capture: wt.keydownListenerCapture}), wt.keydownHandlerAdded = !1), t.parentNode && t.parentNode.removeChild(t), T([document.documentElement, document.body], [x.shown, x["height-auto"], x["no-backdrop"], x["toast-shown"], x["toast-column"]]), nt() && (Mt(), Vt(), Ht(), It())
    }

    function Dt(t, e, n) {
        t.removeEventListener(lt, Dt), y(t, x.hide) && Nt(e, n)
    }

    function Ut(t) {
        var e = R(), n = U(), o = Et.innerParams.get(this), i = Rt.swalPromiseResolve.get(this), r = o.onClose,
            a = o.onAfterClose;
        n && (null !== r && "function" == typeof r && r(n), T(n, x.show), O(n, x.hide), lt && !y(n, x.noanimation) ? n.addEventListener(lt, Dt.bind(null, n, e, a)) : Nt(e, a), i(t || {}))
    }
    ...
    function Zt(t, e) {
        t.removeEventListener(lt, Zt), e.style.overflowY = "auto"
    }

    var Qt = function (t) {
        var e = R(), n = U();
        null !== t.onBeforeOpen && "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), t.animation && (O(n, x.show), O(e, x.fade)), j(n), lt && !y(n, x.noanimation) ? (e.style.overflowY = "hidden", n.addEventListener(lt, Zt.bind(null, n, e))) : e.style.overflowY = "auto", O([document.documentElement, document.body, e], x.shown), t.heightAuto && t.backdrop && !t.toast && O([document.documentElement, document.body], x["height-auto"]), nt() && (t.scrollbarPadding && Tt(), function () {
        ...
        }(), "undefined" != typeof window && jt() && (qt(), window.addEventListener("resize", qt)), f(document.body.children).forEach(function (t) {
            t === R() || function (t, e) {
            ...
            e.scrollTop = 0
        })), ot() || wt.previousActiveElement || (wt.previousActiveElement = document.activeElement), null !== t.onOpen && "function" == typeof t.onOpen && setTimeout(function () {
            t.onOpen(n)
        })
    }, Yt = {
    ...
    var $t, Jt = Object.freeze({
        hideLoading: Ot, disableLoading: Ot, getInput: function (t) {
            var e = Et.innerParams.get(t || this);
            return A(Et.domCache.get(t || this).content, e.input)
        }, close: Ut, closePopup: Ut, closeModal: Ut, closeToast: Ut, enableButtons: function () {
            zt(this, ["confirmButton", "cancelButton"], !1)
        }, disableButtons: function () {
            zt(this, ["confirmButton", "cancelButton"], !0)
        }, enableConfirmButton: function () {
            h("Swal.disableConfirmButton()", "Swal.getConfirmButton().removeAttribute('disabled')"), zt(this, ["confirmButton"], !1)
        }, disableConfirmButton: function () {
            h("Swal.enableConfirmButton()", "Swal.getConfirmButton().setAttribute('disabled', '')"), zt(this, ["confirmButton"], !0)
            ...
            return h("Swal.getProgressSteps()", "const swalInstance = Swal.fire({progressSteps: ['1', '2', '3']}); const progressSteps = swalInstance.params.progressSteps"), Et.innerParams.get(this).progressSteps
        }, setProgressSteps: function (t) {
            h("Swal.setProgressSteps()", "Swal.update()");
            var e = a({}, Et.innerParams.get(this), {progressSteps: t});
            Et.innerParams.set(this, e), gt(e)
            ...
            var p = this;
            !function (t) {
                for (var e in t) At(i = e) || C('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== St.indexOf(o) && C('The parameter "'.concat(o, '" is incompatible with toasts'))), Pt(n = void 0) && h(n, Pt(n));
                var n, o, i
            }(t);
            var f = a({}, kt, t);
            !function (e) {
                e.inputValidator || Object.keys(Ft).forEach(function (t) {
                ...
                var t = U(), n = "string" == typeof e.target ? document.querySelector(e.target) : e.target;
                (!t || t && n && t.parentNode !== n.parentNode) && st(e)
            }(f), Object.freeze(f), Et.innerParams.set(this, f), wt.timeout && (wt.timeout.stop(), delete wt.timeout), clearTimeout(wt.restoreFocusTimeout);
            var m = {
                popup: U(),
                container: R(),
                content: K(),
            ...
            return new Promise(function (t) {
                ...
                Rt.swalPromiseResolve.set(p, t), f.timer && (wt.timeout = new Kt(function () {
                    s("timer"), delete wt.timeout
                ...
                if (wt.keydownHandlerAdded && (wt.keydownTarget.removeEventListener("keydown", wt.keydownHandler, {capture: wt.keydownListenerCapture}), wt.keydownHandlerAdded = !1), f.toast || (wt.keydownHandler = function (t) {
                    return function (t, e) {
                        if (e.stopKeydownPropagation && t.stopPropagation(), "Enter" !== t.key || t.isComposing) if ("Tab" === t.key) {
                            for (var n = t.target, o = et(e.focusCancel), i = -1, r = 0; r < o.length; r++) if (n === o[r]) {
                                i = r;
                                break
                            }
                ...
                }, wt.keydownTarget = f.keydownListenerCapture ? window : m.popup, wt.keydownListenerCapture = f.keydownListenerCapture, wt.keydownTarget.addEventListener("keydown", wt.keydownHandler, {capture: wt.keydownListenerCapture}), wt.keydownHandlerAdded = !0), p.enableButtons(), p.hideLoading(), p.resetValidationMessage(), f.toast && (f.input || f.footer || f.showCloseButton) ? O(document.body, x["toast-column"]) : T(document.body, x["toast-column"]), "select" === f.input || "radio" === f.input) {
                    var u = K(), l = function (t) {
                        return Yt[f.input](u, (e = t, n = [], "undefined" != typeof Map && e instanceof Map ? e.forEach(function (t, e) {
                            n.push([e, t])
                ...
                Qt(f), f.toast || (v(f.allowEnterKey) ? f.focusCancel && I(m.cancelButton) ? m.cancelButton.focus() : f.focusConfirm && I(m.confirmButton) ? m.confirmButton.focus() : a(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()), m.container.scrollTop = 0
            })
        }, update: function (e) {
            var n = {};
            Object.keys(e).forEach(function (t) {
                Gt.isUpdatableParameter(t) ? n[t] = e[t] : C('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'))
            });
            var t = a({}, Et.innerParams.get(this), n);
            vt(t), Et.innerParams.set(this, t), Object.defineProperties(this, {
                params: {
    ...
    function Xt() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && k("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), $t = this;
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
    ...
    Xt.prototype.then = function (t) {
        return Et.promise.get(this).then(t)
    }, Xt.prototype.finally = function (t) {
        return Et.promise.get(this).finally(t)
    }, a(Xt.prototype, Jt), a(Xt, Lt), Object.keys(Jt).forEach(function (e) {
        Xt[e] = function () {
            var t;
            if ($t) return (t = $t)[e].apply(t, arguments)
        }
    }), Xt.DismissReason = t, Xt.version = "8.8.3";
    var Gt = Xt;
