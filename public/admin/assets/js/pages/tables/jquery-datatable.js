...
$(".js-basic-example").DataTable({
    ...
    responsive: false, // Apagado
    
    // NATIVO DE DATATABLES: Esto le dice al script que maneje el desbordamiento
    scrollX: true, 
    scrollCollapse: true,
    autoWidth: false
});
        ...
        ($row.hasClass("adding") &&
            ...
            (values = $row.find("td").map(function () {
                ...
                return $this.hasClass("actions")
                    ? (object.rowSetActionsDefault($row),
                      object.datatable.cell(this).data())
