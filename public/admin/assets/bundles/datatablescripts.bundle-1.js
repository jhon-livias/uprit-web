...
function(n) {
	...
	function i(t) {
		...
		for (e = 0, n = c.length; e < n; e++) if (u = [], !(l = c[e]).sType && l._sManualType) l.sType = l._sManualType;
		else if (!l.sType) {
		...
		var s = function(t, e, n) {
			...
			for (var r, o, i = 0, l = n.length - 1; i < l; i++) {
				if (r = n[i].match(ce), o = n[i].match(fe), r) {
					if (n[i] = n[i].replace(ce, ""), t[n[i]] = [], (a = n.slice()).splice(0, i + 1), r = a.join("."), P.isArray(e)) for (o = 0, l = e.length; o < l; o++) s(a = {}, e[o], r), t[n[i]].push(a);
					else t[n[i]] = e;
					return
				}
	...
	function E(t) {
		...
		for (var o, i, l, s, u, c, f = t.sDom.split(""), d = 0; d < f.length; d++) {
			...
			else if (0 !== qt.ext.feature.length) for (c = 0, s = (l = qt.ext.feature).length; c < s; c++) if (i == l[c].cFeature) {
				o = l[c].fnInit(t);
				break
			}
	...
	function V(a, t, e) {
		...
		u = {
			...
			error: function(t, e) {
				var n = kt(a, null, "xhr", [a, null, a.jqXHR]); - 1 === P.inArray(!0, n) && ("parsererror" == e ? Rt(a, 0, "Invalid JSON response", 1) : 4 === t.readyState && Rt(a, 0, "Ajax error", 7)), dt(a, !1)
			}
		...
		}), s, a) : a.sAjaxSource || "string" == typeof i ? a.jqXHR = P.ajax(P.extend(u, {
			url: i || a.sAjaxSource
		})) : P.isFunction(i) ? a.jqXHR = i.call(l, t, s, a) : (a.jqXHR = P.ajax(P.extend(u, i)), i.data = n)
	}
	function X(e) {
	...
	function bt(t) {
		...
		if (g || !h && !i && !o && s == v(t) && s == c.length) for (e = 0; e < s; e++) null !== (u = N(t, e)) && (r[u].sWidth = Dt(c.eq(e).width()));
		else {
	...
	var Ut, Vt, Xt, Jt, qt = function(b) {
		...
		return this.each(function() {
			...
			if ("table" != this.nodeName.toLowerCase()) Rt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
				...
				if (-1 !== P.inArray(!0, P.map(t, function(t) {
					return h.hasClass(t)
				})) && (P("tbody tr", this).removeClass(t.join(" ")), c.asDestroyStripes = t.slice()), t = [], 0 !== (l = this.getElementsByTagName("thead")).length && (B(c.aoHeader, l[0]), t = U(c)), null === a.aoColumns) for (l = [], r = 0, n = t.length; r < n; r++) l.push(null);
				else l = a.aoColumns;
		...
		se = function(t) {
			...
			if (e) return t.slice();e = [];r = t.length;
			var o, i = 0;a = 0;t: for (; a < r; a++) {
	...
	Vt = function(t, e) {
		...
		iterator: function(t, e, n, a) {
			...
			for ("string" == typeof t && (a = n, n = e, e = t, t = !1), o = 0, i = d.length; o < i; o++) {
				...
				else if ("column" === e || "column-rows" === e || "row" === e || "cell" === e) for (c = this[o], "column-rows" === e && (u = Te(d[o], h.opts)), l = 0, s = c.length; l < s; l++) r = c[l], (r = "cell" === e ? n.call(p, d[o], r.row, r.column, o, l) : n.call(p, d[o], r, o, l, u)) !== j && f.push(r)
			}
			return f.length || a ? ((e = (t = new Vt(d, t ? f.concat.apply([], f) : f)).selector).rows = h.rows, e.cols = h.cols, e.opts = h.opts, t) : this
		},
		
		lastIndexOf: Se.lastIndexOf ||
		function(t, e) {
		...
		if (P.isArray(t)) for (var n = 0, a = t.length; n < a; n++) Vt.register(t[n], e);
		else {
			var r, o, i = t.split("."),
				l = me;
	...
	var De = function(t, e, n, a, r) {
		...
		Te = function(t, e) {
			...
			if ("current" == r) for (n = t._iDisplayStart, a = t.fnDisplayEnd(); n < a; n++) o.push(i[n]);
			else if ("current" == a || "applied" == a) o = "none" == l ? n.slice() : "applied" == l ? i.slice() : P.map(n, function(t) {
			...
			_: function(l, t, s, e, u, c) {
				var f, d, n, h = l.oClasses,
					...
					m = function(t, e) {
						...
						for (n = 0, a = e.length; n < a; n++) if (o = e[n], P.isArray(o)) r = P("<" + (o.DT_el || "div") + "/>").appendTo(t), m(r, o);
						else {
							switch (f = null, d = "", o) {
								case "ellipsis":
	...
	return v.extend(!0, o.defaults, {
		...
		var f, d, n, h = new o.Api(l),
			...
			S = function(t, e) {
				...
				for (n = 0, a = e.length; n < a; n++) if (o = e[n], v.isArray(o)) S(t, o);
				else {
					switch (d = f = "", o) {
						case "ellipsis":
							f = "&#x2026;", d = "disabled";
